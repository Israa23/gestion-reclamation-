...
$rdv = null;
 ...
 $rdvC = new rdvC();
    if (isset($_POST["id_rdv"])&&
        ...
        $rdvC->updaterdv($rdv, $_POST["id_rdv"]);
...
<a class="btn btn-primary mt-2 py-3 px-5" href="listerdv.php">Return to RDV list</a>
    ...
    ?>
        ...
        <form action="" method="POST">
            ...
            <tr>
                    <td>
                        <label for="id_rdv" font-family=" Dayrom, serif" font-weight=" normal" text-transform="uppercase">id_rdv:
                        </label>
                    </td>
                    <td><input type="text"  name="id_rdv" id="id_rdv" value="<?php if(isset($rdv['id_rdv'])) echo $rdv['id_rdv']; ?>" ></td>
                </tr>     
            <tr>
                    <td>
                    ...
                    <td><input type="text" name="firstName" id="firstName" value="<?php if(isset($rdv['firstName'])) echo $rdv['firstName']; ?>" ></td>
                </tr>
            ...
            <tr>
                    ...
                    <td><input type="text" name="lastName" id="LastName" value="<?php if(isset($rdv['lastName'])) echo $rdv['lastName']; ?>" ></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="email" name="email" id="email"  placeholder="mail@serveur.com" value="<?php if(isset($rdv['email'])) echo $rdv['email']; ?>"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <select name="OperationType" id="OperationType" value="<?php if(isset($rdv['OperationType'])) echo $rdv['OperationType']; ?>">
                ...
                <tr>
                    ...
                    <td>
                        <input type="date" name="Desiredcarservicedate" id="Desiredcarservicedate" value="<?php if(isset($rdv['Desiredcarservicedate'])) echo $rdv['Desiredcarservicedate']; ?>">
                    </td>
                </tr>  
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="Ownedcar" id="Ownedcar"value="<?php if(isset($rdv['Ownedcar'])) echo $rdv['Ownedcar']; ?>" ></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="id_car" id="id_car"value="<?php if(isset($rdv['id_car'])) echo $rdv['id_car']; ?>" ></td>
                </tr>    
