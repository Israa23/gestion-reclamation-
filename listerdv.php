...
?>
<a class="btn btn-primary mt-2 py-3 px-5" href="addrdv.php">Add Rendez-vous</a>
<link rel="stylesheet" href="style.css">
<table border="5" color="black" align="center" width="70%">
    <tr> <th>id_rdv</th>
        <th>First Name</th>
        <th>Last Name</th>
        <th>Email</th>
        <th>Desired car service date </th>
    ...
    ?>
        <tr>
            ...
            <td><?= $rdv['lastName']; ?></td>
            <td><?= $rdv['email']; ?></td>
            <td><?= $rdv['Desiredcarservicedate']; ?></td>
            <td><?= $rdv['OperationType']; ?></td>
            <td><?= $rdv['Ownedcar']; ?></td>
            <td><?= $rdv['id_car']; ?></td>
            ...
            <td>
                ...
                <a href="deleterdv.php?id=<?php echo $rdv['id_rdv']; ?>">Delete</a>
            </td>
        </tr>
    <?php
    }
